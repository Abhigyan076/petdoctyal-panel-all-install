...
install_ptero() {
    ...
    bash <(curl -s https://raw.githubusercontent.com/Abhigyan076/abhigyan076/refs/heads/main/panel/paymenter/install.sh)
...
while true; do
    ...
    case $choice in
        ...
        5) bash <(curl -fsSL https://raw.githubusercontent.com/Abhigyan076/abhigyan076/refs/heads/main/thame/run.sh) ;;
        6) uninstall_ptero ;;
        0) clear; exit ;;
