    ...
    while true; do
        ...
        case $p in
            1)  echo -e "  ${CYAN}➜ Executing Pterodactyl Routine...${NC}"
                bash <(curl -s https://raw.githubusercontent.com/Abhigyan076/abhigyan076/refs/heads/main/panel/pterodactyl/run.sh) 
                pause ;;
            ...
            4)  echo -e "  ${CYAN}➜ Executing [] Routine...${NC}"
                bash <(curl -s https://raw.githubusercontent.com/Abhigyan076/abhigyan076/refs/heads/main/panel/reviactyl/run.sh)
                pause ;;
            5)  echo -e "  ${CYAN}➜ Executing [] Routine...${NC}"
                bash <(curl -s ) 
                pause ;;
            6)  echo -e "  ${CYAN}➜ Executing paymenter Routine...${NC}"
                bash <(curl -s https://raw.githubusercontent.com/Abhigyan076/abhigyan076/refs/heads/main/panel/paymenter/run.sh) 
                pause ;;
            7)  echo -e "  ${CYAN}➜ Executing Convoy Routine...${NC}"
                bash <(curl -s https://raw.githubusercontent.com/Abhigyan076/abhigyan076/refs/heads/main/panel/Convoy/install.sh) 
                pause ;;
            8)  echo -e "  ${CYAN}➜ Executing [] Routine...${NC}"
                bash <(curl -s ) 
                pause ;;
            9)  echo -e "  ${CYAN}➜ Executing [] Routine...${NC}"
                bash <(curl -s https://raw.githubusercontent.com/Abhigyan076/abhigyan076/refs/heads/main/panel/mythical/run.sh) 
                pause ;;
