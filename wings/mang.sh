...
auto_setup() {
    while true; do
        ...
        1)
            ...
            # Run Config Script
            bash <(curl -fsSL https://raw.githubusercontent.com/Abhigyan076/abhigyan076/refs/heads/main/wings/config.sh)
            echo ""
        ...
        2)
            ...
            if [ -z "$CMD" ]; then
                ...
                bash <(curl -fsSL https://raw.githubusercontent.com/Abhigyan076/abhigyan076/refs/heads/main/wings/mang.sh)
            fi
