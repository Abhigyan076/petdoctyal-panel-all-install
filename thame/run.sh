...
while true; do
    ...
    case $main in
                ...
                case $bp in
                    1)
                        if [ "$installed" = false ]; then
                            ...
                            yes | bash <(curl -s https://raw.githubusercontent.com/abhigyan/Abhigyan-Cloud/refs/heads/main/thame/install.sh)
                        else
        ...
        2)
            ...
            bash <(curl -s https://raw.githubusercontent.com/abhigyan/Abhigyan-Cloud/refs/heads/main/thame/thames.sh)
            pause
            ;;
        ...
        3)
            ...
            bash <(curl -s https://raw.githubusercontent.com/abhigyan/Abhigyan-Cloud/refs/heads/main/thame/Extension2.sh)
            pause
            ;;
