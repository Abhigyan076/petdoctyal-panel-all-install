...
EOF
    ...
    2)
        ...
        bash <(curl -s https://raw.githubusercontent.com/abhigyan/Abhigyan-Cloud/refs/heads/main/setup%20vm/vm-1.sh)
    ...
    3)
        ...
        bash <(curl -s https://raw.githubusercontent.com/abhigyan/Abhigyan-Cloud/refs/heads/main/setup%20vm/vm-2.sh)
    ...
    4)
        ...
        bash <(curl -s https://raw.githubusercontent.com/abhigyan/Abhigyan-Cloud/refs/heads/main/setup%20vm/vm-3.sh)
