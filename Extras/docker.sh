...
function create_container() {
    ...
    case ${OS_CHOICE:-1} in
      1) IMAGE="abhigyan/ubuntu:22" ; DEFAULT_HOST="ubuntu22" ;;
      2) IMAGE="abhigyan/ubuntu:24" ; DEFAULT_HOST="ubuntu24" ;;
      3) IMAGE="abhigyan/debain:11" ; DEFAULT_HOST="debian11" ;;
      4) IMAGE="abhigyan/debain:12" ; DEFAULT_HOST="debian12" ;;
      5) IMAGE="abhigyan/debain:13" ; DEFAULT_HOST="debian13" ;;
      *) IMAGE="abhigyan/debain:12" ; DEFAULT_HOST="debian12" ;;
    esac
